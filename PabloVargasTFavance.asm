...
MAIN_LOOP:
                brclr Banderas_H,$04,INIT_CNF   ; Inicia en modo configuracion
...
MODO_MEDICION:
                tst VELOC
                beq MENSAJE_MED                         ; Si la velocidad es cero, retorna
                jsr PANT_CTL
                rts

MENSAJE_MED:    brset Banderas_H,$08,MED_RETORNO        ; Si el mensaje ya se encuentra en pantalla, no lo pone de nuevo
...
CHECK_PF:       brset Banderas_L,$08,MOSTRAR_VELOC
                ...
                clr VELOC
                movb #$0F, PIEH
                bclr Banderas_L,$10                        ; Apaga la alarma
                jsr CARGAR_LCD
                bra PANT_RETORNO
...
PTH0:           bset PIFH,$01
                ...
                bne CALC_RETORNO
                movb #$0a,Cont_Reb
                ;brclr Banderas_H,$01,CALC_RETORNO
                ldab TICK_VEL
                ldx #00
                tfr b,x
                ldd #6624
...
RTI_ISR:        bset CRGFLG,$80    ; Se borra la bandera de la interrupcion RTI
                tst Cont_Reb
                beq Retornar        ; Esta suburutina se dedica exclusivamente a reducir el contador de rebotes
                dec Cont_Reb
