...
CONT_RTI        ds 1
BANDERAS:       ds 1        ;bit 5 cambio nodo, bit 4 rtc activado, bit 6 rs , bit 7 ESCRITURALECTURAIIC
...
ALARMA:         dw $0009
T_WRITE_RTC:    db $30,$59,$11,$02,$04,$12      ;Hexadecimal porque es bcd, El bit 6 de horas se deja abajo porque es en formato 24 H
                org $1040
T_Read_RTC:     ds 6
...
;       Puerto H sw
                ...
                bset PIFH, $0F
;       RTI
                movb #$65, RTICTL       ; esto lo pone en 49.152 ms
...
;       IIC
                ...
                movb #$00,IBCR           ;IBEN = 1, IBIE=1, el resto cero porque aun no se inicia la comunicacion
                cli
...
;               inicializacion
                ...
                movb #$00, CONT_REB
                bclr BANDERAS,$0F      ;Poner las banderas en 0 FIXME
...
READ_RTC:
        LDAA Index_RTC
        LBEQ READ_RTC_primer_dato
        CMPA #1
        LBEQ READ_RTC_segundo_dato
        CMPA #2
        LBEQ READ_RTC_tercer_dato
        CMPA #9
        LBEQ READ_RTC_ultimo_dato
        CMPA #8
        LBNE READ_RTC_no_es_penultimo_dato
        BSET IBCR,$08     ;No ACK
READ_RTC_no_es_penultimo_dato:
        ...
        LBRA READ_RTC_incrementar_y_retornar
READ_RTC_primer_dato:
        movb Dir_Seg,IBDR    ; Mandando word adress de segundos Dir_Seg
        LBRA READ_RTC_incrementar_y_retornar
READ_RTC_segundo_dato:
        MOVB Dir_RD,IBDR   ; dIRECCION READ
        bset IBCR,$04
        LBRA READ_RTC_incrementar_y_retornar
READ_RTC_tercer_dato:
        BCLR IBCR,$1c         ; Repeated start = 0, y Rx
        ldab #$FF,IBDR        ;dummy
        LBRA READ_RTC_incrementar_y_retornar
READ_RTC_ultimo_dato:
        BCLR IBCR,$28   ;borrar no ack ;SENAL DE STOP
        BSET IBCR,$10   ; TX
        ;CLR Index_RTC
        RTS
READ_RTC_incrementar_y_retornar:
        INC Index_RTC
        RTS
...
PH0_ISR:        bset PIFH, $01
                tst CONT_REB
                bne returnPH
                brset BANDERAS,$08,returnPH     ;Si ya se configuro la hora no se vuelve a hacer
                movb #2,CONT_REB
